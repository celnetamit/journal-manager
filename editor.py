...
5. A CAPTION IS NOT A HEADING: A paragraph that opens with a figure or table label and a number — "Table 2: Comparative Summary", "Fig: 2 Design of Prototype", "Figure 1. Actual model" — is a CAPTION, and rule 2 does not apply to it. Its "Table 2"/"Figure 2" is the element's number, which every "see Table 2" in the text points at, NOT heading numbering. Never delete that label or its number; format the caption under the Table & Figure rules instead. If one paragraph contains BOTH a heading and a caption (e.g. "3.2 Sensor Fusion    Fig: 2 Design of Prototype"), keep BOTH pieces of text and raise a query asking for them to be split into two paragraphs — do not drop either one.""",
    },
    {
        "id": "citation",
